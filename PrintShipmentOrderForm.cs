...
{
    public partial class PrintShipmentOrderForm : Form
    {
        ...
        private void PrintShipmentOrderForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
